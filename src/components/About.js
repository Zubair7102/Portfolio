  ...
  return (
    <section id="about" name="about" className="px-6 py-24 md:px-12">
      <div className="mx-auto max-w-6xl">
        ...
        <h2 className="mt-2 text-3xl font-bold text-white sm:text-4xl">Java backend + automation engineering profile</h2>

        <article className="mt-8 rounded-3xl border border-white/10 bg-gray-900/60 p-7 backdrop-blur">
          <p className="leading-relaxed text-gray-300">
            I am a Computer Science graduate (2025) focused on building high-performance backend systems and
            quality-first delivery pipelines. I work across Java Spring Boot services, automated testing,
            CI/CD integration, and deployment tooling to ship reliable products faster.
          </p>

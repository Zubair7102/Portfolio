  ...
  return (
    <section id="projects" name="projects" className="px-6 py-24 md:px-12">
      <div className="mx-auto max-w-6xl">
        <p className="text-sm font-bold uppercase tracking-[0.24em] text-cyan-300">Portfolio</p>
        <h2 className="mt-2 text-3xl font-bold text-white sm:text-4xl">Selected projects & case studies</h2>
            ...
            >
              ...
              <div className="space-y-4 p-5">
                ...
                <p className="text-sm text-gray-400">
                  Built with a focus on clean UI, responsiveness, and smooth interactions.
                </p>
